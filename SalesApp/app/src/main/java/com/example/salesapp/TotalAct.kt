...
class TotalAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var url="http://192.168.1.10/SalesWeb/get_total.php?bill_no="+intent.getStringExtra("bno")
        ...
        paypal_btn.setOnClickListener{
            ...
            var payment=PayPalPayment(BigDecimal.valueOf(amount),"USD","PayPal",PayPalPayment.PAYMENT_INTENT_SALE)
